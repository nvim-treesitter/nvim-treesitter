...
describe('indent Swift:', function()
  ...
  describe('new line:', function()
    ...
    run:new_line(
      'declarations.swift',
      { on_line = 17, text = 'var textInsideWillSet = 1', indent = 6 }
    )
    run:new_line(
      'declarations.swift',
      { on_line = 22, text = 'var textInsideOverrideFunc', indent = 4 }
    )
    run:new_line(
      'declarations.swift',
      { on_line = 28, text = 'var InsideProtocol: String { get }', indent = 2 }
    )
  end)
end)
