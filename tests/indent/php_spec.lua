...
describe("indent PHP:", function()
  ...
  describe("new line:", function()
    ...
    run:new_line("issue-6888.php", { on_line = 1, text = "$a;", indent = 0 })
    run:new_line("issue-6888.php", { on_line = 2, text = "case Funday = 2;", indent = 4 })
    run:new_line("issue-6888.php", { on_line = 5, text = "$a;", indent = 0 })
    run:new_line("issue-6888.php", { on_line = 7, text = "$a;", indent = 4 })
    run:new_line("issue-6888.php", { on_line = 10, text = "$a;", indent = 0 })
  end)
end)
