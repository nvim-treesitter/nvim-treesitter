...
Legend:
- **Tier:** _stable_, _core_, _community_, or _unmaintained_
...
[awk](https://github.com/Beaglefoot/tree-sitter-awk) | unmaintained | `H  J ` |  |  | 
...
[blueprint](https://gitlab.com/gabmus/tree-sitter-blueprint.git) | unmaintained | `H    ` |  |  | @gabmus
...
[cmake](https://github.com/uyha/tree-sitter-cmake) | unmaintained | `HF   ` |  |  | @uyha
...
[d](https://github.com/CyberShadow/tree-sitter-d) | unmaintained | `HFIJ ` | ✓ |  | @nawordar
...
[ebnf](https://github.com/RubixDev/ebnf) | unmaintained | `H    ` |  |  | @RubixDev
...
[elm](https://github.com/elm-tooling/tree-sitter-elm) | unmaintained | `H  J ` |  |  | @zweimach
[elsa](https://github.com/glapa-grossklag/tree-sitter-elsa) | core | `HFIJL` |  |  | @glapa-grossklag, @amaanq
[elvish](https://github.com/ckafi/tree-sitter-elvish) | community | `H  J ` |  |  | @ckafi
[embedded_template](https://github.com/tree-sitter/tree-sitter-embedded-template) | unmaintained | `H  J ` |  |  | 
...
[foam](https://github.com/FoamScience/tree-sitter-foam) | unmaintained | `HFIJL` |  |  | @FoamScience
...
[hack](https://github.com/slackhq/tree-sitter-hack) | unmaintained | `H    ` |  |  | 
[hare](https://github.com/amaanq/tree-sitter-hare) | core | `HFIJL` |  |  | @amaanq
[haskell](https://github.com/tree-sitter/tree-sitter-haskell) | unmaintained | `HF J ` |  |  | 
...
[hocon](https://github.com/antosha417/tree-sitter-hocon) | unmaintained | `H  J ` |  | ✓ | @antosha417
...
[htmldjango](https://github.com/interdependence/tree-sitter-htmldjango) | unmaintained | `HFIJ ` |  |  | @ObserverOfTime
[http](https://github.com/rest-nvim/tree-sitter-http) | core | `H  J ` |  | ✓ | @amaanq
[ini](https://github.com/justinmk/tree-sitter-ini) | unmaintained | `HF   ` |  |  | @theHamsta
...
[mlir](https://github.com/artagnon/tree-sitter-mlir) | unmaintained | `H   L` | ✓ |  | @artagnon
[nickel](https://github.com/nickel-lang/tree-sitter-nickel) | unmaintained | `H I  ` |  |  | 
...
[org](https://github.com/milisims/tree-sitter-org) | unmaintained | `     ` |  |  | 
...
[phpdoc](https://github.com/claytonrcarter/tree-sitter-phpdoc) | unmaintained | `H    ` |  | ✓ | @mikehaertl
...
[poe_filter](https://github.com/ObserverOfTime/tree-sitter-poe-filter)[^poe_filter] | unmaintained | `HFIJ ` |  |  | @ObserverOfTime
...
[pug](https://github.com/zealot128/tree-sitter-pug) | unmaintained | `H  J ` |  |  | @zealot128
...
[racket](https://github.com/6cdh/tree-sitter-racket) | community | `HF J ` |  |  | @6cdh
...
[scheme](https://github.com/6cdh/tree-sitter-scheme) | community | `HF J ` |  |  | @6cdh
[scss](https://github.com/serenadeai/tree-sitter-scss) | community | `HFI  ` |  |  | @elianiva
[slint](https://github.com/jrmoulton/tree-sitter-slint) | unmaintained | `H I  ` |  |  | @jrmoulton
...
[t32](https://codeberg.org/xasc/tree-sitter-t32) | unmaintained | `HFIJL` |  |  | @xasc
...
[todotxt](https://github.com/arnarg/tree-sitter-todotxt.git) | unmaintained | `H    ` |  |  | @arnarg
...
[v](https://github.com/vlang/vls) | community | `HFIJL` |  |  | @kkharji
