...
return {
  ...
  c3 = {
    install_info = {
      revision = '5abce05689bf46999c17bd0dcda2f75b8de61d0d',
  ...
  clojure = {
    install_info = {
      revision = 'be514eec2c86d560c18fab146e9298e21b8eab62',
  ...
  cpp = {
    install_info = {
      revision = '2871652b9893ab19e621628da03e670227a5d9d0',
  ...
  cylc = {
    install_info = {
      revision = '5517ecade85b1de85ed8e0cb742b81decc64183a',
  ...
  desktop = {
    install_info = {
      revision = '5fc42b211b261d7c10f97f2c7fa9665cd0d3c8a0',
  ...
  editorconfig = {
    install_info = {
      revision = '9281e7d8522cc0d06b61f97920e27936fa12be11',
  ...
  erlang = {
    install_info = {
      revision = '07dad1469ecb7df80f2b6d5178f79564d19d67e0',
  ...
  fortran = {
    install_info = {
      revision = '1b08f4c65fb47c76d3532cd3f7432d03abb9ef69',
  ...
  gap = {
    install_info = {
      revision = '8dee53cfb962600dd35ca25432f005e7920e89f2',
  ...
  javadoc = {
    install_info = {
      revision = 'c5b7341f62498ea139d591a5d6f450dc879b53b0',
  ...
  liquidsoap = {
    install_info = {
      revision = '05a5dbb23addd207a295b904e44dbdd321b3b332',
  ...
  markdown = {
    install_info = {
      ...
      revision = '7462bb66ac7e90312082269007fac2772fe5efd1',
  ...
  mlir = {
    install_info = {
      generate = true,
      revision = 'ddd4cd2e274813b97624fd3f30803f1db2001474',
  ...
  nu = {
    install_info = {
      revision = '436b3f94578974d6e0c89c201d4b99329ad0e944',
  ...
  perl = {
    install_info = {
      branch = 'release',
      revision = 'a2d8e5a32a63019d25bb7452455f4d646d11cce5',
  ...
  powershell = {
    filetype = 'ps1',
    install_info = {
      revision = '103a700af551ba8d3402fd68e6f3cd4bf45cbe80',
  ...
  r = {
    install_info = {
      revision = '7b4eb04dfcc86e6705cade825f8c1edbd46584b2',
  ...
  rust = {
    install_info = {
      revision = '3691201b01cacb2f96ffca4c632c4e938bfacd88',
  ...
  slint = {
    install_info = {
      revision = '03f24aa22d6712f79004286df6dd416ca6d2a91d',
  ...
  ssh_config = {
    install_info = {
      revision = '2d620d0ad636705800cf0ddb92c30afe703cd84f',
  ...
  superhtml = {
    install_info = {
      ...
      revision = '13f5a2221cb748bbe50ad702e89362afd5b925a7',
  ...
  swift = {
    install_info = {
      generate = true,
      revision = 'd8816ef1aae8d1e7cf23adff2ace9d556d4b369f',
  ...
  systemverilog = {
    install_info = {
      revision = '0dc5d86af86120094d9f1268613b529142212ddd',
  ...
  t32 = {
    install_info = {
      revision = '412cf98b2784dfe9c95ce0d7de840605c6953417',
  ...
  tera = {
    install_info = {
      revision = '53ca9100f231b72474225d98c9e53d1a4275046d',
  ...
  v = {
    install_info = {
      ...
      revision = '6c511fc884312720e30ef5d169c63fe5f3d0209f',
  ...
  xresources = {
    install_info = {
      revision = '65d52b286af0b2dd7153e045869a566b33a28f44',
