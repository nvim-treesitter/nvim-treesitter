...
return {
  ...
  angular = {
    install_info = {
      ...
      revision = 'f12fc56469d778285fb35b5bdb943edcfe77c48a',
  ...
  earthfile = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      revision = '3ded1cba9eab14b07377b700b1132d259480abae',
  ...
  idl = {
    install_info = {
      files = { 'src/parser.c' },
      revision = '3bb3c69a050c68c24482e45465b41652628044b7',
  ...
  javascript = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      revision = 'c67e8556d09bfdc21919839486d03e37ee44a6ce',
  ...
  kotlin = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      revision = 'eca05edbab1918d7d36a0d30d086ba7b6b1e8803',
  ...
  mlir = {
    install_info = {
      files = { 'src/parser.c' },
      generate = true,
      revision = 'ab7708c4aed1ff0919d6f6fd3e463fe75ba645be',
  ...
  php = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      location = 'php',
      revision = 'd5aea05a70c5d021fa746516391f156d35658875',
  ...
  ql = {
    install_info = {
      files = { 'src/parser.c' },
      revision = 'fa5c3821dd2161f5c8528a8cbdb258daa6dc4de6',
  ...
  qmljs = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      generate_from_json = true,
      revision = '239f2627b4c7859fd9adc53609cb40fa0a5431ce',
  ...
  tact = {
    install_info = {
      files = { 'src/parser.c' },
      revision = 'f65460eb0746037bc15913e2737afcf87745b66b',
  ...
  templ = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      generate_from_json = true,
      revision = '81e16d4ca796407361dad83ffee472715015339c',
  ...
  tsx = {
    install_info = {
      ...
      generate_from_json = true,
      location = 'tsx',
      revision = 'dcbbd9406a63fd1e0a42c90ab9451c6127ebd4b3',
  ...
  typst = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      revision = 'b19e64087a426fe059fc6103ff0766c607f41888',
  ...
  wit = {
    install_info = {
      files = { 'src/parser.c' },
      revision = '3d6124cfe88555ecee1ba97d6d76c70d13af927a',
