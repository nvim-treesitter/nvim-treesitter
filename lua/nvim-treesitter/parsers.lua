...
return {
  ...
  css = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      revision = '2e868a75a518531656b493cba36ef60d8c61cc89',
  ...
  idl = {
    install_info = {
      files = { 'src/parser.c' },
      revision = 'd9a260eda455deaa36d2edf398963b0736ed0845',
  ...
  javascript = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      revision = 'c0027460e8f9629afeeb27f7949ecf961c82d707',
  ...
  mlir = {
    install_info = {
      files = { 'src/parser.c' },
      generate = true,
      revision = 'ed528701a1ee52d4735c3439da262c898e506fc3',
  ...
  swift = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      generate = true,
      revision = '5f5d7a2a04f2d367a010ed908cc956e7b05fde4f',
  ...
  templ = {
    install_info = {
      files = { 'src/parser.c', 'src/scanner.c' },
      generate_from_json = true,
      revision = 'c06e7bf0edfa211f6a7665a3c7fa25c1198850b2',
